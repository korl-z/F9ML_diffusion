...
#         data_dir,
#         score_cut=0.57,
#         save_path=output_dir / "f16_score_distributionsEDM_test.png"
#     )
...
def plot_score_distributions_from_data(
    data_dir, classifier_name="MC", score_cut=0.55, save_path=None
):
    """
    classifier score distributions with ratio subplot
    """
    data_dir = Path(data_dir)

    df = pd.read_csv(data_dir / f"score_distributions_data{classifier_name}DDPM.csv")
